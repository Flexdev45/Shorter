...
function main(){
    # Script settings.
    scriptversion='0.1'; # the version of the script.
    author='Ek-dev';
    ...
    function loadmodule(){
        ...
        function continue2(){ # This will be the function that will short our url.
            # We make a variable to store out shorten url.
            out='shorten.txt';
